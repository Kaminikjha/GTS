              ...
              <div className="p-5 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    <p
                      className={`text-sm text-gray-800 transition-all duration-300 ${
                        expandedJobIds.includes(job._id) ? 'block' : 'hidden'
                      }`}
                    >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start">
                    <div>
                      ...
                      <p className="text-sm text-gray-800">{job.description || 'No description available.'}</p>
                    </div>
                  </div>
                </div>
              </div>
...
const Dashboard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { title, skills, jobType, salary, experience, description } = formData;

    if (!title || !skills || !jobType || !salary || !experience || !description) {
    ...
    try {
      ...
      if (res.ok) {
        alert(isEditing ? 'Job updated!' : 'Job posted!');
        fetchJobs();
        setIsEditing(false);
        setEditId(null);
        setFormData({ 
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">Job Portal Dashboard</h1>
        
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="w-full lg:w-1/3 xl:w-1/3">
            <div className="bg-white p-6 rounded-lg shadow-md sticky top-6 border border-orange-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Salary (in ₹)</label>
                  <input
                    type="number"
                    name="salary"
                  ...
                  >
                    ...
                    <div className="px-5 py-3 bg-gray-50 border-t border-gray-200 flex justify-end space-x-2">
                      <button
                        ...
                        className="flex items-center px-3 py-1 bg-orange-600 text-white text-sm font-medium rounded-md hover:bg-orange-700 transition-colors"
                      >
                        <FaEdit className="mr-1" /> Edit
                      </button>
                      <button
                        onClick={() => handleDeleteJob(job._id)}
                        className="flex items-center px-3 py-1 bg-red-600 text-white text-sm font-medium rounded-md hover:bg-red-700 transition-colors"
                      >
