...
const MoreJobs = () => {
  ...
  // More Career Opportunities in Career Section
      ...
      <div className="max-w-8xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {additionalJobs.map((job, index) => (
            <div
              key={index}
              className="backdrop-blur-sm border border-[#f06321]/90 rounded-xl p-6 flex flex-col justify-between hover:shadow-lg transition-all duration-300"
            >
              <div>
                <h3 className="text-2xl font-bold text-white underline mb-2">
                  {job.title}
                </h3>
                <p className="text-white text-base leading-relaxed mb-4">
                  Skills: {job.skills}
                </p>
                <span className="inline-block bg-[#f06321]/90 text-white text-xs px-3 py-1 rounded-full">
                  {job.type}
                </span>
              </div>
              <button
                onClick={() => handleApply(job.title)}
                className="mt-4 w-full md:w-auto  border-2 border-[#f06321]/90  text-white  font-semibold px-6 py-2 rounded-lg hover:bg-white hover:text-[#f06321] transition-all duration-300"
              >
                Apply Now
              </button>
            </div>
...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 backdrop-blur-md flex flex-wrap justify-between md:items-center text-[#f06321] opacity-90 px-4 sm:px-10 py-6 font-robotoSlab z-50">
      ...
      >
        <li
          className="hover:opacity-95 hover:scale-105 md:hover:underline transition p-2 md:p-0 text-[#f06321] opacity-90 text-lg md:text-2xl cursor-pointer"
        ...
        <li
          className="flex justify-center items-center gap-1 hover:opacity-95 border border-1 border-orange-600 hover:scale-105 rounded-lg transition duration-300 md:p-1 text-[#f06321] opacity-90 text-lg md:text-2xl cursor-pointer"
...
const Career = () => {
  ...
  const jobs = [
    ...
    },
    {
      ...
      skills: "HTML, CSS, JavaScript (React/Angular optional)",
      type: "Job",
    },
    {
      title: "Database",
    ...
    { title: "Authentication", skills: "JWT / OAuth", type: "Job" },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {jobs.map((job, index) => (
            ...
            >
              ...
              <button
                onClick={() => handleApply(job.title)}
                className="mt-4 w-full md:w-auto  border-2 border-[#f06321]/90   font-semibold text-white px-6 py-2 rounded-lg hover:bg-white hover:text-[#f06321] transition-all duration-300"
              >
                Apply Now
              </button>
            </div>
...
// App Component (Updated with new route)
const App = () => {
  const location = useLocation();
  ...
  return (
    <AuthProvider>
      <Routes>
        ...
        <Route path="/more-jobs" element={<MoreJobs />} /> {/* New Route */}
