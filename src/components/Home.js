...
<p className='text-sm md:text-3xl text-[#f06321] leading-tight tracking-tight'>
...
<button className='mt-5 md:mt-10  text-white text-sm md:text-2xl py-2 px-3 text-sm md:text-lg md:py-2 md:px-4 hover:opacity-85 duration-300 hover:scale-105 font-semibold rounded-3xl bg-[#f06321] '>Contact Us</button>
</div>
